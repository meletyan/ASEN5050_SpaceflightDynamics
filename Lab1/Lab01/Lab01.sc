...
BEGIN Epoch
    ...
    Epoch        12 Sep 2014 00:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	12 Sep 2014 00:00:00.000000000
			EventEpoch
...
Start                   12 Sep 2014 00:00:00.000000000
Stop                    13 Sep 2014 00:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	12 Sep 2014 00:00:00.000000000
...
BEGIN Animation
    ...
    StartTime          12 Sep 2014 00:00:00.000000000
    EndTime            13 Sep 2014 00:00:00.000000000
    CurrentTime        12 Sep 2014 00:00:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        C:\Users\ED\Documents\STK 10\Lab01
            BaseName         Frame
            Digits           4
            Frame            0
...
END MapData
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	4 Oct 2015 18:00:00.000000000
				Stop	5 Oct 2015 18:00:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
    ...
    BEGIN ReportFavorites
        BEGIN Class
            ...
            BEGIN Favorite
                Type    Graph
                BaseDir User
                Style   J2000 Velocity
            END Favorite
            BEGIN Favorite
                Type    Graph
                BaseDir User
                Style   J2000 Position
            END Favorite
            BEGIN Favorite
                Type    Report
                BaseDir Install
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Facility/BaikonurCosmodrome
        Facility/BaikonurCosmodrome
    END Instance
    Instance Facility/KSC
        Facility/KSC
    END Instance
    Instance Facility/Madrid
        Facility/Madrid
    END Instance
    Instance Facility/Perth
        Facility/Perth
    END Instance
    Instance Satellite/Grace
        *
        Satellite/Grace
    END Instance
    Instance Satellite/HUBBLE_SPACE_TE_20580
        Satellite/HUBBLE_SPACE_TE_20580
    END Instance
    Instance Satellite/HW3
        Satellite/HW3
    END Instance
