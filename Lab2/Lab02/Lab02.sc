...
BEGIN Epoch
    ...
    Epoch        31 Oct 2015 18:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	31 Oct 2015 18:00:00.000000000
			EventEpoch
...
Start                   31 Oct 2015 18:00:00.000000000
Stop                    1 Nov 2015 18:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	31 Oct 2015 18:00:00.000000000
...
BEGIN Animation
    ...
    StartTime          31 Oct 2015 18:00:00.000000000
    EndTime            1 Nov 2015 18:00:00.000000000
    CurrentTime        31 Oct 2015 18:00:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            ...
            OrthoDisplayDistance 200000000.000000
            ...
            BEGIN ZoomLocations
                BEGIN ZoomLocation
                    CenterLat    89.999999
                    CenterLon    0.000000
                    ZoomWidth    236.196000
                    ZoomHeight   118.588615
                End ZoomLocation
            END ZoomLocations
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Satellite/Bielliptic
        Satellite/Bielliptic
    END Instance
    Instance Satellite/Hohmann
        Satellite/Hohmann
    END Instance
    Instance Satellite/HohmannTarget
        Satellite/HohmannTarget
    END Instance
END References
